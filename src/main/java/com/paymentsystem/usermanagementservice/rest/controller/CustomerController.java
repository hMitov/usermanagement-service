package com.paymentsystem.usermanagementservice.rest.controller;
...
import com.paymentsystem.usermanagementservice.rest.port.CustomerRestPort;
...
@Api(tags = {"customer"}, value = "Customer", produces = APPLICATION_JSON_VALUE)
